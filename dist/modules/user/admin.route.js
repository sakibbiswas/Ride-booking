...
const user_model_1 = require("../user/user.model"); // path adjust 
...
router.get('/analytics', (0, auth_middleware_1.default)(user_model_1.UserRole.ADMIN), analytics_controller_1.getAnalytics);
